...
function EsriMap() {
  const mapDiv = useRef(null); //reference to div that the MapView will use to display the map
  ...
  /**
   * Create a WebMap and View from map in AGOL.
   * We also disable popups from appearing on the map in this method.
   */
  const configureMap = () => {
